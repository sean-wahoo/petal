...
export default async (req: NextApiRequest, res: NextApiResponse) => {
  ...
  try {
    ...
    switch (current_friend_data?.status) {
      case 'sent': throw { code: 'request-already-sent', message: "Request already sent!" }
      case 'pending': throw { code: 'request-pending', message: "Request pending!" }
      case 'accepted': throw { code: 'already-friends', message: "Already friends!" }
      default: break;
    }
