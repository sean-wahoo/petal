...
import styles from "src/styles/components/editor.module.scss";
...
const Editor: React.FC<EditorProps> = ({
  ...
  const extensions = {
    post: [
      ...
      Placeholder.configure({
        ...
        emptyEditorClass: styles.editor_empty,
      }),
    ],
    comment: [
      Document,
    ...
    reply: [
      ...
      Text,
      Placeholder.configure({
        placeholder: "Leave a nice reply!",
        emptyEditorClass: styles.editor_empty,
      }),
    ],
  };
  type extensionKey = keyof typeof extensions;
  const key = type as extensionKey;
  const editor = useEditor({
    extensions: extensions[key] as any,
    autofocus: true,
    editable: true,
    injectCSS: false,
    onUpdate({ editor }) {
      updateEditorContent(editor.getJSON());
    },
  });
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.button_row}>{buttons[key]}</div>
      <EditorContent
        data-editor-type={type}
        data-editor-parent_id={parent_id}
        className={`${styles.editor} ${styles[type]}`}
        id="editor"
        editor={editor}
      />
    </div>
